<template>
  <div>
    <div class="dashboard-banner">
      ...
      <img v-if="!authStore.tenantName && !authStore.tenantIcon" src="/images/app_logo_lg.png" alt="" />
    ...
    <div class="dashboard-stats-container">
      <div class="card">
        <div class="stat-container">
          <div>
            <p>Players</p>
            <h3 style="color: #E22F89">{{ addCommas(24564) }}</h3>
          </div>
          <img src="/images/svg/Players.svg" alt="Pl" style="fill: #E22F89">
        </div>
      </div>
      <div class="card">
        <div class="stat-container">
