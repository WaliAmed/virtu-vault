          ...
          <div class="player-modal">
            ...
            <div class="gallery-container">
                <div class="img-outer-container" v-for="b in 10"  @click="isSelected = !isSelected">
                    <div class="gallery-img-container" :class="{'isSelected': isSelected}" :style="[isSelected ? 'border: 2px solid #E22F89' : '' ]">
                        <div class="bg-image">
                        ...
                        <div class="check-icon" v-if="isSelected">
                            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
                                <g filter="url(#filter0_d_1811_39730)">
                                    <path d="M18.5524 3H7.75234C5.76411 3 4.15234 4.61177 4.15234 6.6V17.4C4.15234 19.3882 5.76411 21 7.75234 21H18.5524C20.5406 21 22.1524 19.3882 22.1524 17.4V6.6C22.1524 4.61177 20.5406 3 18.5524 3Z" fill="#E22F89"/>
                                </g>
...
.icon {
    ...
    fill: #FFF;
    border-radius: 50%;
    filter: drop-shadow(3.75px 3.75px 7.5px rgba(143, 216, 198, 0.25));
}
